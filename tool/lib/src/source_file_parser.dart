...
//
  ...
  void _updateLocationAfter(String line) {
    ...
    if (match != null) {
      ...
      _location =
          _location.parent ?? (throw StateError('Location parent is null'));
    }
  ...
  bool _updateState(String line) {
    ...
    if (match != null) {
      var startChapterName = match[1]!;
      var endChapterName = match[3]!;
      _push(
    ...
    if (line.trim() == "*/" && _currentState.end != null) {
      _location = _locationBeforeBlock ??
          (throw StateError('_locationBeforeBlock is null'));
      _pop();
      return true;
    }
