...
//> Inheritance begin-super-scope
    ...
    if (stmt.superclass != null) {
      beginScope();
      Token token = new Token(TokenType.IDENTIFIER, "super", null, 0);
      scopes.peek().put("super", new Variable(token, VariableState.DECLARED));
    }
//< Inheritance begin-super-scope
//> resolve-methods
...
//> resolver-begin-this-scope
    beginScope();
    Token token = new Token(TokenType.IDENTIFIER, "this", null, 0);
    scopes.peek().put("this", new Variable(token, VariableState.DECLARED));
